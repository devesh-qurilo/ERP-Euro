// src/modules/employee/hr/screens/EmployeeHRAppreciationsScreen.js
...
import {
  selectApprecsData,
  selectApprecsLoading,
  selectApprecsError,
} from '../store/selectors';

import AppreciationsListTable from '../components/AppreciationsListTable';
import AwardsProfileTable from '../components/AwardsProfileTable';
...
export default function EmployeeHRAppreciationsScreen() {
  const dispatch = useDispatch();
  const rows = useSelector(selectApprecsData);
  const loading = useSelector(selectApprecsLoading);
  const error = useSelector(selectApprecsError);
  ...
  return (
    <ScrollView contentContainerStyle={styles.wrap}>
      ...
      {/* Tables */}
      {view === 'list' ? (
        <AppreciationsListTable rows={filtered} />
      ) : (
        <AwardsProfileTable rows={filtered} />
      )}
