...
//  *  - items: array
//  *  - loading: bool
//  *  - onOpenActions: fn(row)
//  *  - minWidth: number (optional) default 1000
//  *  - rowHeight: number (optional) default 68
//  *  - maxHeight: number (optional) max height for rows area; if not provided, uses 320
//  */
...
//   // Header columns widths must match row columns below
//   const header = (
//     <Row
//       style={{
...
//         // Important for nested scrolling on Android
...
//               maxHeight: maxHeight,
//             }}
//             // allow nested vertical inside outer horizontal
...
//                       Unpaid :{' '}
//                       {Number(row.unpaidAmount || 0).toLocaleString(undefined, {
//                         minimumFractionDigits: 2,
//                       })}
//                     </Text>
//                   </View>
