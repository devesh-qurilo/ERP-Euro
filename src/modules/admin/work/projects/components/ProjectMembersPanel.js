...
//     () => empOpts.filter(e => !members.some(m => m.employeeId === e.value)),
//     [empOpts, members],
//   );
...
//       // Backend rule: admin already exists
//       if (msg.includes('already has an admin')) {
//         Alert.alert('Admin already exists', msg, [
...
//               Alert.alert(
//                 'Error',
//                 e?.response?.data?.message || 'Failed to remove admin',
//               );
//             }
//           },
//         },
...
//         }}
//       >
//         <Text style={{ fontSize: 16, fontWeight: '800' }}>Project Members</Text>
...
//                 <Text style={{ color: '#6b7280' }}>{item.designation}</Text>
...
//                           text: 'Remove',
//                           style: 'destructive',
//                           onPress: () => removeEmployee(item.employeeId),
//                         },
//                       ],
//                     )
//                   }
...
//         onSelect={o => setSelectedEmp(o.value)}
//         onClose={() => {
//           setAddOpen(false);
//           setSelectedEmp(null);
//         }}
